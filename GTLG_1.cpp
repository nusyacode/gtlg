...
#endif
{
	...
	cout << "Growtopia private server (c) GTLG" << endl;
				...
				case ENET_EVENT_TYPE_RECEIVE:
				{
					...
					case 2:
					{
						...
						if (cch.find("action|dialog_return") == 0)
						{
							...
							if (btn == "yesesto") {
								Player::OnConsoleMessage(peer, "`oIf you want to buy dm GTLG team!");
							}
							if (btn == "no") {
								sendShop(peer);
							}
							...
							SKIPFind3:;
								...
								if (getAdminLevel(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass) == 4) {
									...
									if (((PlayerInfo*)(peer->data))->currentWorld != "EXIT") {
										...
										Player::OnConsoleMessage(peer, "`oUsed `4GTLG's `2Fast-Realtime-Clear system`w (like real gt)!``");
									}
								}
							}
